...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ url('templates/panel') }}/node_modules/@fortawesome/fontawesome-free/css/all.min.css">
        ...
        <link rel="stylesheet" href="{{ url('templates/panel') }}/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
        <link rel="stylesheet" href="{{ url('templates/panel') }}/node_modules/jvectormap/jquery-jvectormap.css">
        <link rel="stylesheet" href="{{ url('templates/panel') }}/node_modules/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css">
        <link rel="stylesheet" href="{{ url('templates/panel') }}/node_modules/weather-icons/css/weather-icons.min.css">
        <link rel="stylesheet" href="{{ url('templates/panel') }}/node_modules/c3/c3.min.css">
        <link rel="stylesheet" href="{{ url('templates/panel') }}/node_modules/perfect-scrollbar/css/perfect-scrollbar.css">
    ...
    <body>
                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="index.html">
                            <div class="logo-img">
                               <img src="{{ url('templates/panel') }}/src/img/brand-white.svg" class="header-brand-img" alt="lavalite"> 
                            </div>
        ...
        <script>window.jQuery || document.write('<script src="{{ url('templates/panel') }}/src/js/vendor/jquery-3.3.1.min.js"><\/script>')</script>
        ...
        <script src="{{ url('templates/panel') }}/node_modules/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
        <script src="{{ url('templates/panel') }}/node_modules/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js"></script>
        <script src="{{ url('templates/panel') }}/node_modules/jvectormap/jquery-jvectormap.min.js"></script>
        <script src="{{ url('templates/panel') }}/node_modules/jvectormap/tests/assets/jquery-jvectormap-world-mill-en.js"></script>
        <script src="{{ url('templates/panel') }}/node_modules/moment/moment.js"></script>
        <script src="{{ url('templates/panel') }}/node_modules/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
