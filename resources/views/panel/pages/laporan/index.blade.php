                                ...
                                @forelse ($keg->subkegiatan as $sub)
                                    @foreach ($sub->indikator_subkegiatan as $isk)
                                        <tr style="background-color: #FFD966">
                                            ...
                                            {{-- triwulan I --}}
                                            <td class="text-center">
                                                {{ isset($sub->triwulan('I')->target) ? $sub->triwulan('I')->target . ' ' . $sub->triwulan('I')->satuan : '0' }}
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-right">@currency(isset($sub->triwulan('I')->pagu) ? $sub->triwulan('I')->pagu : 0)</td>
                                            {{-- triwulan II --}}
                                            <td class="text-center">
                                            ...
                                            <td class="text-right">@currency(isset($sub->triwulan('II')->pagu) ? $sub->triwulan('II')->pagu : 0)</td>
                                            {{-- triwulan III --}}
                                            <td class="text-center">
                                            ...
                                            <td class="text-right">@currency(isset($sub->triwulan('III')->pagu) ? $sub->triwulan('III')->pagu : 0)</td>
                                            {{-- triwulan IV --}}
                                            <td class="text-center">
                                            ...
                                            <td class="text-right">@currency(isset($sub->triwulan('IV')->pagu) ? $sub->triwulan('IV')->pagu : 0)</td>
                                        </tr>
                                    @endforeach
                                @empty
                                @endforelse
