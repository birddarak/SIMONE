<tr style="background-color: rgb(218, 218, 218);" class="collapse" id="kegiatan-{{ $kegiatan->uuid }}" wire:ignore>
    ...
    <td class="p-1">
        <div class="input-group m-0">
            <select class="form-control form-control-sm" wire:model='triwulan' wire:keydown.enter='store("{{ $kegiatan->uuid }}")'>
    ...
    <td class="text-center p-1">
        <button class="btn btn-primary" wire:click='store("{{ $kegiatan->uuid }}")'>
