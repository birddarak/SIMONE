                ...
                <tr class="bg-light">
                    ...
                    <td class="p-1">
                        <textarea type="text" value="{{ $kegiatan->title }}"
                            ...
                            wire:keydown.enter="updateKegiatan('{{ $kegiatan->uuid }}', 'title', $event.target.value)"
                            class="form-control " rows="3">{{ $kegiatan->title }}</textarea>
                    </td>
                    <td class="p-1 col-2">
                    ...
                    <td class="p-1 text-center">
                        <div class="btn-group">
                            <a href="{{ route('dpa.subkegiatan', $kegiatan->uuid) }}" class="btn btn-info btn-icon">
