...
<tr>
    ...
    <td class="p-1" colspan="4">
        <input type="text" value="{{ $indikator_kegiatan->title }}"
            ...
            wire:keydown.enter="updateIndikator('{{ $indikator_kegiatan->uuid }}', 'title', $event.target.value)"
            class="form-control">
    </td>
    <td class="text-center">
        <button class="btn btn-danger btn-icon" wire:confirm='Ingin menghapus Indikator Kegiatan ini?'
