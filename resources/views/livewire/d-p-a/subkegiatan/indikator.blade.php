...
<tr>
    ...
    <td class="p-1" colspan="4">
        <input type="text" value="{{ $indikator_subkegiatan->title }}"
            ...
            wire:keydown.enter="updateIndikator('{{ $indikator_subkegiatan->uuid }}', 'title', $event.target.value)"
            class="form-control">
    </td>
    <td class="p-1 text-center">
        <button class="btn btn-danger btn-icon" onclick="return confirm('Ingin menghapus Indikator Sub Kegiatan ini?')"
